<%@ Page Title="" Language="C#" MasterPageFile="~/Ogretmen.Master" AutoEventWireup="true" CodeBehind="DuyuruEkle.aspx.cs" Inherits="WebApplication1.DuyuruEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <asp:Label for="DropDownList1" runat="server" Text="Duyuran Öğretmen:" Style="font-weight: 700"></asp:Label>
    ...
    <br />
    <div>
        <asp:Label for="TextArea1" runat="server" Text="Duyuru İçerik:" Style="font-weight: 700"></asp:Label>
